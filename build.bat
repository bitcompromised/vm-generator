...
node "C:\Users\eadan\OneDrive\Desktop\Claude-Projects\vm-gen\bin\vm-gen.js" build "%1" -o "C:\Users\eadan\OneDrive\Documents\vm-builds\vm\%name%\%name%.vm.js" --profile aggressive --target lua
